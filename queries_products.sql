...
INSERT INTO products (name, price, can_be_returned) VALUES ('Leather sofa', 5000.99, true);
...
UPDATE products SET price = price + 20;
-- Query 14: 14. There is a new company policy: everything is returnable. Update the database accordingly. --
